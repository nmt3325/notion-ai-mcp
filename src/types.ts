...
export interface ChatSession { threadId:string; configId:string; contextId:string; originalDatetime:string; model:string; reasoningEffort?:string|undefined; updatedConfigIds:string[]; turnCount:number; transport?:"inference_transcript"|"agent_service" }
