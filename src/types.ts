...
export interface ChatStartResult { status:"running"; jobId:string; conversationId:string; userMessageId?:string|undefined; model:string; reasoningEffort?:string|undefined; startedAt:number; rehydrated?:boolean|undefined; hint:string }
export interface CompletedChatResult extends ChatResult { status:"completed"; jobId:string; userMessageId?:string|undefined; rehydrated?:boolean|undefined }
export interface PendingChatResult { status:"pending"; jobId:string; conversationId:string; userMessageId?:string|undefined; model:string; reasoningEffort?:string|undefined; startedAt:number; elapsedMs:number; rehydrated?:boolean|undefined; hint:string }
export type ChatWaitResult = CompletedChatResult|PendingChatResult;
export interface ChatJobLookup { status:ChatJobStatus; source:"job"|"thread"; conversationId:string; userMessageId?:string|undefined; matchedBy?:"userMessageId"|"jobId"|"latestAssistant"|undefined; partialText?:string|undefined; jobId?:string|undefined; model?:string|undefined; reasoningEffort?:string|undefined; text?:string|undefined; error?:string|undefined; usage?:ChatJobUsage|undefined; startedAt?:number|undefined; finishedAt?:number|undefined; elapsedMs?:number|undefined; hint?:string|undefined }
